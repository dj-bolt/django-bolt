...
fn _core(_py: Python<'_>, m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    // The asyncio loop machinery lives in the bolt-loop crate; its Python half
    // is django_bolt._worker_loop.
    bolt_loop::init("django_bolt._worker_loop");
    bolt_loop::register(m)?;
